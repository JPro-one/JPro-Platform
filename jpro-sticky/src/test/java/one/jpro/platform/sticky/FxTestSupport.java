...
/**
 * Shared plumbing for the headless JavaFX unit tests of the desktop-parity implementations
 * ({@link FXStickyImpl}, {@link FXFixedImpl}, {@link StickyOverlay}, {@link AnchorGeometry}). No
 * TestFX, no window: the toolkit is bootstrapped once with {@link Platform#startup} and work runs on
 * the JavaFX thread, with layout forced synchronously via {@code root.applyCss()} + {@code root.layout()}.
 *
 * @author Tobias Horak
 */
final class FxTestSupport {
     ...
     */
    static void onFx(FxAction action) {
