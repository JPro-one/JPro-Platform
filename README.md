...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-auth-core:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-scenegraph:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-file:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-image-manager:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-mail:0.5.4-SNAPSHOT")
}
```
...
dependencies {
    implementation("one.jpro.platform:jpro-media:0.5.4-SNAPSHOT")
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-core:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-dev:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-popup:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-mdfx:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-session:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation 'one.jpro.platform:jpro-utils:0.5.4-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-webrtc:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-youtube:0.5.4-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-html-scrollpane:0.5.4-SNAPSHOT")
}
```
