...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-auth-core:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-scenegraph:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-file:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-image-manager:0.4.0")
}
```
...
dependencies {
    implementation("one.jpro.platform:jpro-media:0.4.0")
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-core:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-dev:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-popup:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-mdfx:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-session:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-webrtc:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-youtube:0.4.0")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-html-scrollpane:0.4.0")
}
```
...
```groovy
dependencies {
    implementation 'one.jpro.platform:tree-showing:0.4.0'
}
```
...
```groovy
dependencies {
    implementation 'one.jpro.platform:freeze-detector:0.4.0'
}
```
