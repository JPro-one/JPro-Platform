...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-auth-core:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-scenegraph:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-image-manager:0.2.17-SNAPSHOT")
}
```
...
dependencies {
    implementation("one.jpro.platform:jpro-media:0.2.17-SNAPSHOT")
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-core:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-dev:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-routing-popup:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-mdfx:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-session:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-webrtc:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-youtube:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation("one.jpro.platform:jpro-html-scrollpane:0.2.17-SNAPSHOT")
}
```
...
```groovy
dependencies {
    implementation 'one.jpro.platform:tree-showing:0.2.17-SNAPSHOT'
}
```
...
```groovy
dependencies {
    implementation 'one.jpro.platform:freeze-detector:0.2.17-SNAPSHOT'
}
```
