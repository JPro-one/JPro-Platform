...
import one.jpro.platform.auth.authentication.CredentialValidationException;
import one.jpro.platform.auth.authentication.UsernamePasswordCredentials;
...
import static one.jpro.platform.auth.utils.AuthUtils.BASE64_ENCODER;
